...
raw_data <- read_csv("/Users/fangwanghanyue/Desktop/STA304-Starter-Folder/Inputs/Data/raw_data.csv")
...
#### Save data ####
write_csv(cleaned_data, "/Users/fangwanghanyue/Desktop/STA304-Starter-Folder/Outputs/data/cleaned_data.csv")
